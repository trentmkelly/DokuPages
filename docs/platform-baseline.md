...
- R2 stores media bodies, old media revisions, and large exported archives.
...
- R2 bucket and KV namespace names are declared in `wrangler.toml`; placeholder IDs must be replaced after resources are provisioned.

...
| `/doku.php?do=admin&page=safefnrecode`              | Returns explicit DokuWiki-styled `501` HTML; use `npm run safefn:recode` as an operator migration tool.                                                |
...
| `/lib/exe/fetch.php?media=<media>`                  | Redirects to `/media/<media>`, preserving media revision, download, resize token, and cache parameters.                                                |
...
| `/lib/exe/indexer.php`                              | Runs the native D1 page indexer task for `id`, returning DokuWiki's task-runner GIF by default. See `docs/task-runner.md` for replaced scheduled jobs. |
| `/lib/exe/taskrunner.php`                           | Alias for the native D1 page indexer task runner. See `docs/task-runner.md` for replaced scheduled jobs.                                               |

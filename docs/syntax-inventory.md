...
| RSS feed aggregation syntax      | unsupported     |           1 | `wiki:syntax`                                                           | Requires a Pages-native replacement; the renderer does not fetch or cache remote feeds. |
...
| Syntax plugin macros             | unsupported     |           1 | `wiki:syntax`                                                           | Current content uses DokuWiki's INFO syntax plugin macro.                               |

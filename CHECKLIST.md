...
- [ ] Implement route handling for recent changes.
...
- [ ] Write importer for wordblock configuration.
...
- [ ] Add integration tests for revisions.
- [ ] Add integration tests for diff.

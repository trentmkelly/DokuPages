...
describe("handleRequest", () => {
  ...
  it("audits documented legacy URL compatibility routes", async () => {
    const redirects: Array<[string, number, string]> = [
      ...
      ["/doku.php?do=admin&page=styling", 301, "/admin/styling"],
  ...
  it("renders an edit form for existing pages", async () => {
    ...
    expect(html).toContain('id="edbtn__bold"');
    expect(html).toContain('title="Bold Text [B]"');
    expect(html).toContain('src="/images/toolbar/bold.png"');
    expect(html).toContain('id="edbtn__underline"');
    expect(html).toContain('id="edbtn__mono"');
    expect(html).toContain('id="edbtn__strike"');
    expect(html).toContain('id="edbtn__hequal"');
    expect(html).toContain('data-toolbar-action="autohead"');
    expect(html).toContain('id="edbtn__headlines"');
    expect(html).toContain('data-picker-target="picker__headlines"');
    expect(html).toContain('id="edbtn__link"');
    expect(html).toContain('data-link-wizard="1"');
    expect(html).toContain('id="edbtn__extlink"');
    expect(html).toContain('data-sample="http://example.com|External Link"');
    expect(html).toContain('id="edbtn__ol"');
    expect(html).toContain('id="edbtn__ul"');
    expect(html).toContain('id="edbtn__hr"');
    expect(html).toContain('id="edbtn__media"');
    expect(html).toContain('data-media-popup="1"');
    expect(html).toContain('id="edbtn__smileys"');
    expect(html).toContain('data-picker-target="picker__smileys"');
    expect(html).toContain('id="edbtn__chars"');
    expect(html).toContain('data-picker-target="picker__chars"');
    expect(html).toContain('id="picker__headlines"');
    expect(html).toContain('class="picker a11y pk_hl"');
    expect(html).toContain('id="picker__smileys"');
    expect(html).toContain('data-picker-insert=":-)"');
    expect(html).toContain('src="/images/smileys/smile.svg"');
    expect(html).toContain('id="picker__chars"');
    expect(html).toContain('data-picker-insert="Ω"');

...
- [x] Add visual regression baselines captured from a running upstream DokuWiki instance, not only the Pages port.
- [x] Add a checklist review after importing production content so gaps not visible in starter pages are captured.
